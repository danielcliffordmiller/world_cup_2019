...
result(16, 0, 1). % rsa v chn
result(17, 3, 2). % aus v bra
result(19, 1, 0). % eng v arg
result(18, 0, 5). % jam v ita
result(20, 2, 1). % jpn v sco
result(22, 3, 1). % ned v cmr
result(21, 2, 0). % can v nzl
result(23, 3, 0). % usa v chi
result(24, 5, 1). % swe v tha
result(28, 0, 0). % chn v esp
result(26, 1, 2). % kor v nor
result(25, 0, 1). % nga v fra
